# -*- coding: utf-8 -*-
"""マップノードアイコン6種: バトル/群れ/精鋭/宝箱/休憩/ボス (seed固定で画風統一)"""
...
JOBS = {
    "node_battle":   (ICON + "Two crossed steel short swords with gold crossguards and red grips.", 777001),
    "node_horde":    (ICON + "A tattered orange war banner on a wooden pole with a black fang emblem.", 777001),
    "node_elite":    (ICON + "A menacing purple horned demon skull.", 777001),
    "node_treasure": (ICON + "A wooden treasure chest with gold trim, lid slightly open with gold coins inside.", 777001),
    "node_rest":     (ICON + "A cozy campfire, orange flame over crossed logs and small stones.", 777001),
    "node_boss":     (ICON + "A sinister dark metal royal crown with sharp spikes and a red gem.", 777001),
}

def build(seed, text):
    return {
        "1": {"class_type": "SaveImage", "inputs": {"images": ["8", 0], "filename_prefix": "db_node"}},
