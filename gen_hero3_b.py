...
STYLE = ("masterpiece, best quality, score_7, safe. "
    ...
    # 等身
    "heroic proportions, five heads tall, small head relative to the body, visible neck, "
    "broad shoulders much wider than the head, long strong legs, tall standing figure, "
...
JOBS = {
    "hero3_b1": (STYLE + GARETH + "calm stoic expression, sharp eyes.", 331101),
    "hero3_b2": (STYLE + GARETH + "brave dignified expression.", 331202),
    "hero3_b3": (STYLE + GARETH + "noble commanding expression.", 331303),
    "hero3_b4": (STYLE + GARETH + "confident fierce expression.", 331404),
}

def build(seed, text):
    return {"1":{"class_type":"SaveImage","inputs":{"images":["8",0],"filename_prefix":"db_hero3b"}},
      ...
      "28":{"class_type":"EmptyLatentImage","inputs":{"width":640,"height":896,"batch_size":1}},
