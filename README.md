...
**▶ プレイ: https://hikaru0306.github.io/dropbattle-rogue/** （PC/スマホ対応・ホーム画面に追加でアプリ風に遊べる）

分岐マップでルートを選びながら、同色ドロップを消して敵と戦うパズルローグライク。
3章制／雑魚30種＋ボス10種（取り巻き付き）／特殊ドロップ14種＋強化／レリック28種／消費アイテム10種。
`index.html` をブラウザで開くだけでも遊べる（単一ファイル・React UMD CDN）。
