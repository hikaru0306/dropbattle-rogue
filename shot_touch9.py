...
ALL="mandra mudman alraune banshee voids titania toadking fgolem jotun".split()
GROUPS=[(f"t{i//3+1}", ALL[i:i+3]) for i in range(0,len(ALL),3)]
errors=[]
with sync_playwright() as p:
    ...
    for label,kinds in GROUPS:
        ...
        page.screenshot(path=SHOT+rf"\shot_touch_{label}.png")
    b.close()
