# -*- coding: utf-8 -*-
"""ガレス(hero3) 第7弾（顎下の毛なし） → assets_cand/
...
GARETH = ("A stalwart anthropomorphic lion heavy knight, "
    ...
    "a golden brown mane spills out only from the back and sides of the helmet behind his head, "
...
JOBS = {
    "hero3_g1": (STYLE + GARETH + "calm stoic expression, sharp eyes.", 991501),
    "hero3_g2": (STYLE + GARETH + "brave dignified expression.", 991602),
    "hero3_g3": (STYLE + GARETH + "noble commanding expression.", 991703),
    "hero3_g4": (STYLE + GARETH + "confident fierce expression.", 991804),
    "hero3_g5": (STYLE + GARETH + "quiet resolute expression.", 991905),
    "hero3_g6": (STYLE + GARETH + "steady watchful expression.", 992006),
}

def build(seed, text):
    return {"1":{"class_type":"SaveImage","inputs":{"images":["8",0],"filename_prefix":"db_hero3g"}},
