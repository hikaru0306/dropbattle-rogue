...
JOBS = {
    "hero3_d1": (STYLE + GARETH + "calm stoic expression, sharp eyes.", 661101),
    "hero3_d2": (STYLE + GARETH + "brave dignified expression.", 661202),
    "hero3_d3": (STYLE + GARETH + "noble commanding expression.", 661303),
    "hero3_d4": (STYLE + GARETH + "confident fierce expression.", 661404),
}

def build(seed, text):
    return {"1":{"class_type":"SaveImage","inputs":{"images":["8",0],"filename_prefix":"db_hero3d"}},
